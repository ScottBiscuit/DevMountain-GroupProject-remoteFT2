...
function WishlistModal({
  ...
  const changeEntryTitle = (e) => setEntryTitle(e.target.value);

  return (
    // countriesList &&
    <Form>
      <Form.Group>
        <Form.Label>Title your wishlist entry:</Form.Label>
        <Form.Control onChange={changeEntryTitle} value={entryTitle} />
      </Form.Group>
      <Form.Group>
